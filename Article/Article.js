...
function ArticleCreator(obj) {
  ...
  let headr = document.createElement("h2");
  headr.textContent = obj.title;

  let datePart = document.createElement("p");
  datePart.classList.add("date");
  datePart.textContent = obj.date;

  let paraElement1 = document.createElement("p");
  paraElement1.textContent = obj.firstParagraph;

  let paraElement2 = document.createElement("p");
  paraElement1.textContent = obj.secondParagraph;
  ...
  divArticle.appendChild(headr);
  divArticle.appendChild(datePart);
  divArticle.appendChild(paraElement1);
  divArticle.appendChild(paraElement2);
  divArticle.appendChild(paraElement3);
...
data.forEach(item => {
  let newArticle = new ArticleCreator(item);
